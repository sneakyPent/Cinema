          ...
          <mdb-card-body class="mx-4 mb-2">
            <form novalidate @submit="checkForm">
              <div class="grey-text">
                <mdb-row>
                  <mdb-col>
                    <mdb-input v-model="formInfo.name" icon="user" label="Όνομα" type="text" required
                               invalidFeedback="Please provide a valid city." class="mb-3"/>
                  </mdb-col>
                  <mdb-col>
                    <mdb-input v-model="formInfo.surname" label="Επίθετο" type="text" required class="mb-3"/>
                  </mdb-col>
                </mdb-row>
                <mdb-row>
                  <mdb-col>
                    <mdb-input v-model="formInfo.username" icon="key" label="Όνομα χρήστη" group type="text" required
                               class="mb-3"/>
                  </mdb-col>
                  <mdb-col>
                    <mdb-input v-model="formInfo.password" label="Κωδικός" type="text" required class="mb-3"/>
                  </mdb-col>
                </mdb-row>
                <mdb-row>
                  <mdb-col>
                    <mdb-input v-model="formInfo.email" class="mb-3" label="email" icon="envelope" group type="email"
                ...
                <mdb-row>
                  <mdb-col class="mb-2 mt-3 d-flex justify-content-center">
                    <mdb-form-inline>
                      <mdb-input required type="radio" id="option5-1" name="groupOfMaterialRadios2" radioValue="user"
                                 v-model="formInfo.role"
                                 label="Χρήστης"/>
                      <mdb-input required type="radio" id="option5-2" name="groupOfMaterialRadios2" radioValue="owner"
                                 v-model="formInfo.role"
