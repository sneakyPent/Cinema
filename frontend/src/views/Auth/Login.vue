          ...
          <mdb-card>
            <mdb-card-body class="mx-4">
              <form @submit.prevent="login">
                ...
                <mdb-input v-model="credentials.username" label="Username" type="text" required class="mb-5"/>
                <mdb-input v-model="credentials.password" label="Password" type="password" containerClass="mb-0"/>
                <div class="text-center mb-3">
                  <mdb-btn type="submit" gradient="blue" rounded class="btn-block z-depth-1a">Είσοδος</mdb-btn>
                </div>
              </form>
            </mdb-card-body>
            <mdb-modal-footer class="mx-5 pt-3 mb-1">
              <p class="font-small grey-text d-flex justify-content-end">Δεν είστε μέλος;
                <router-link :to="{name: 'Register', query: {next: $route.query.next}}">Εγγραφή</router-link>
              </p>
            </mdb-modal-footer>
          </mdb-card>
        </mdb-col>
